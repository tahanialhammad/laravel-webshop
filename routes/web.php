...
Route::get('/shoping-cart', [App\Http\Controllers\ProductController::class, 'showCart'])->name('cart.show');
Route::get('/chechout/{amount}', [App\Http\Controllers\ProductController::class, 'checkout'])->name('cart.checkout');
